...
OBJECTS=$(GEN_DIR)/main.object $(GEN_DIR)/timer.object $(GEN_DIR)/scheduled_output_action.object $(GEN_DIR)/DirectMemory.object $(GEN_DIR)/TiAdc.object $(GEN_DIR)/AdcMeasurement.object
