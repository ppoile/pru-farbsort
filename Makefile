...
INCLUDE=--include_path=$(PRU_LIB)/include --include_path=$(PRU_LIB)/include/am335x
STACK_SIZE=0x100
HEAP_SIZE=0x100
GEN_DIR=gen
...
OBJECTS=$(GEN_DIR)/main.object $(GEN_DIR)/timer.object $(GEN_DIR)/scheduled_output_action.object $(GEN_DIR)/adc.object $(GEN_DIR)/hal.object $(GEN_DIR)/util.object $(GEN_DIR)/rpmsg_handler.object
